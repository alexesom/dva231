...
<?php
    ...
    <section class="news">
        <div class="news0 headlines" onclick="nextSlide()">
            <div class="slide active fade">
                <div class="slide-text">
                    ...
                    <div class="slide-text__description">Quod deleniti laboriosam cupiditate dolor sit amet consectetur adipisicing elit.</div>
                </div>
            </div>
        ...
        <div id="news2" class="news2">
            ...
            <span  id="news2__headline" class="news2__headline" onmouseover="hoverNews()" ><h4><?php echo $news_data->news[1]->title ?></h4>
        ...
        <div class="news4">
        <iframe class="news4__youtubeVideo" src="https://www.youtube.com/embed/rB2RAEbuI6o" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
        <div class="news5">
        ...
        <div class="news6">
            <a class="twitter-timeline" data-theme="dark" href="https://twitter.com/NASA?ref_src=twsrc%5Etfw">Tweets by NASA</a>
